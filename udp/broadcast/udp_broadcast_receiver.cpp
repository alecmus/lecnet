/*
** udp_broadcast_receiver.cpp - udp broadcast receiver implementation
**
...
class liblec::lecnet::udp::broadcast::receiver::receiver_impl {
public:
...
liblec::lecnet::udp::broadcast::receiver::~receiver() {
	stop();
...
bool liblec::lecnet::udp::broadcast::receiver::run(long long timeout_milliseconds,
	std::string& error) {
	if (running()) {
